<?php
// ubah ini untuk prefix link depan sebelum keyword brand
$prefix = 'id';
...
if (isset($_GET[$prefix])) {
    ...
    $target_string = strtolower($_GET[$prefix]);
    $titles = [
    "$BRAND | Slot Gacor Server Kamboja Resmi RTP Tinggi Terbaru 2026",
    "$BRAND - Situs Slot Online Terpercaya Jackpot Maxwin Hari Ini",
    "$BRAND | Link Slot Gacor Resmi Deposit Cepat Server Kamboja",
    "$BRAND - Daftar Slot Gacor RTP Live Tertinggi Anti Rungkad",
    "$BRAND | Slot Online Terbaik dengan Bonus Member Baru 2026",
    "$BRAND - Situs Slot Resmi RTP Tinggi Mudah Maxwin Hari Ini",
    "$BRAND | Agen Slot Gacor Terpercaya Server Kamboja 2026",
    "$BRAND - Slot Online Jackpot Besar Deposit QRIS & E-Wallet",
    "$BRAND | Website Slot Gacor Resmi Auto Maxwin Terbaru",
    "$BRAND - Slot RTP Live Tinggi Resmi Bonus New Member"
];

$descriptions = [
    "$BRAND menghadirkan permainan slot online RTP tinggi dengan sistem stabil, transaksi cepat, serta pilihan game populer yang siap memberikan pengalaman bermain terbaik setiap hari.",
    "Nikmati pengalaman bermain di $BRAND dengan koleksi slot gacor terbaru, proses deposit instan, penarikan cepat, dan peluang jackpot maxwin yang lebih optimal.",
    "$BRAND merupakan situs slot terpercaya yang menyediakan game dari provider populer, layanan profesional, serta akses mudah melalui berbagai perangkat.",
    "Bergabung bersama $BRAND untuk menikmati slot online berkualitas dengan RTP live tinggi, bonus menarik, dan sistem keamanan yang terjamin.",
    "$BRAND menawarkan berbagai pilihan permainan slot resmi, transaksi cepat, tampilan responsif, dan kesempatan meraih kemenangan maksimal setiap saat.",
    "Temukan berbagai game slot favorit di $BRAND dengan server stabil, deposit praktis, bonus harian, serta pengalaman bermain yang nyaman.",
    "$BRAND hadir sebagai pilihan situs slot online modern dengan provider lengkap, layanan 24 jam, dan proses transaksi yang cepat serta aman.",
    "Mainkan slot gacor favorit di $BRAND yang didukung RTP tinggi, promo menarik, dan sistem otomatis untuk memberikan pengalaman bermain lebih praktis.",
    "$BRAND menyediakan ratusan permainan slot terbaru dari provider ternama dengan akses cepat, bonus melimpah, dan peluang jackpot yang kompetitif.",
    "Rasakan sensasi bermain slot online bersama $BRAND dengan koleksi game lengkap, layanan profesional, serta sistem deposit dan withdraw yang efisien."
];
...
$description = $descriptions[array_rand($descriptions)];
    ...
    if (isset($BRAND)) {
        ...
        if (isset($fullUrl)) {
          ...
          // ubah ini untuk link
          $linkBanner = $urlPath;
          // ubah ini untuk gambar banner dan product
          $srcBanner = $baseUrl."assets/maxwin.png";
          $srcProduct = $baseUrl."assets/slot.png";
        } else {
          // Redirect jika URL tidak valid
header("Location: https://t.ly/kage303", true, 302);
exit();
}
} else {
    header("Location: https://t.ly/kage303", true, 302);
...
<html ⚡ lang="id">
  <head>
    ...
    <meta name="keywords" content="situs casino, slot bet 200, slot gacor, slot gacor gampang menang, slot gacor hari ini" />
    ...
    <meta property="og:image" content="https://ik.imagekit.io/euyarjnjt/kage303.jpg">
    <meta property="og:url" content="https://ahomethai.com/gyeonggi/?id=<?php echo $BRAND; ?>?id=<?php echo $BRAND; ?>">
  ...
  <body>
        ...
        <div class="header-holder d-flex flex-wrap justify-content-between align-items-center">
          <div class="brand-logo d-none d-lg-inline-block">
            <div class="logo d-block">
              <a href="https://t.ly/kage303">
                <img src="https://amplumen.lol/iw/img/ayoyo.gif" alt="SLOT GACOR">
              </a>
            </div>
          </div>
            ...
            <div class="header-bottom">
              <div class="header-wrapper">
                ...
                <div class="menu-area">
                  <ul class="menu">
                    <li>
                      <a href="https://t.ly/kage303">Home</a>
                    </li>
                    <li>
                      <a href="https://t.ly/kage303">Slot</a>
                    </li>
                    <li>
                      <a href="https://t.ly/kage303">Promo</a>
                    </li>
                    <li>
                      <a href="https://t.ly/kage303">Masuk</a>
                    </li>
                    <li>
                      <a href="https://t.ly/kage303">Daftar</a>
                    </li>
                  </ul>
    ...
    <div class="banner__slider">
      <div class="container p-0">
        <amp-img src="https://ik.imagekit.io/euyarjnjt/kage303.jpg" width="600" height="600" alt="SLOT GACOR" layout="responsive" />
      </div>
    </div>
    <section class="counter padding-bottom">
      <div class="container p-1">
        <div class="row g-1 justify-content-center">
          <div class="col-6">
            <a href="https://t.ly/kage303" target="_blank" rel="noopener nofollow" class="cta-masuk text-center d-block">DAFTAR 1</a>
          </div>
          <div class="col-6">
            <a href="https://t.ly/kage303" target="_blank" rel="noopener nofollow" class="cta-daftar text-center d-block">DAFTAR 2</a>
          </div>
        </div>
      </div>
      <div class="container">
    ...
    <div class="container">
      ...
      <div class="slot-online container-global">
        <div class="super-gacor">
          <amp-img src="https://ik.imagekit.io/euyarjnjt/New%20Folder/gates-of-olympus.webp" width="300" height="300" layout="responsive" alt="Gates Of Olympus"></amp-img>
        ...
        <div class="super-gacor">
          <amp-img src="https://ik.imagekit.io/euyarjnjt/New%20Folder/caishen-wins.webp" width="300" height="300" layout="responsive" alt="Caishen Wins"></amp-img>
    ...
    <div class="container">
      ...
      <div class="slot-online container-global">
        <div class="super-gacor">
          <amp-img src="https://ik.imagekit.io/euyarjnjt/New%20Folder/fortune-tiger.webp" width="300" height="300" layout="responsive" alt="Fortune Tiger"></amp-img>
          <p class="provider-gacor m-1 text-small text-bold">PG Soft</p>
        ...
        <div class="super-gacor">
          <amp-img src="https://ik.imagekit.io/euyarjnjt/New%20Folder/mahjong-ways.webp" width="300" height="300" layout="responsive" alt="Mahjong Ways"></amp-img>
          <p class="provider-gacor m-1 text-small text-bold">PG Soft</p>
    ...
    <div class="container">
      ...
      <div class="slot-online container-global">
        <div class="super-gacor">
          <amp-img src="https://ik.imagekit.io/euyarjnjt/New%20Folder/genies-3-wishes.webp" width="300" height="300" layout="responsive" alt="Genie's 3 Wishes"></amp-img>
          <p class="provider-gacor m-1 text-small text-bold">PG Soft</p>
        ...
        <div class="super-gacor">
          <amp-img src="https://ik.imagekit.io/euyarjnjt/New%20Folder/queen-of-bounty.webp" width="300" height="300" layout="responsive" alt="Queen Of Bounty"></amp-img>
          <p class="provider-gacor m-1 text-small text-bold">PG Soft</p>
      ...
      <h1 style="text-align: center;"><strong><?php echo $BRAND; ?> <?= $title ?></strong></h1>
 
<p>Selamat datang di <a href="https://ahomethai.com/gyeonggi/?id=<?php echo $BRAND; ?>"><strong  style="color: rgb(255, 0, 0);">SLOT GACOR</strong></a>, salah satu situs slot depo 10k via QRIS paling terlengkap dan terpercaya di Indonesia dengan menjamin setiap pemain tidak akan kecewa seperti fitur rtp live resmi, mudah menang dan peluang besar mendapatkan scatter dari slot88. Selain itu layanan yang sangat terkemuka menyediakan customer service online 24 jam yang ramah dan responsif. Slot88 terkenal gacor yang merupakan partner resmi SLOT GACOR yang menjadikan situs ini populer sebagai agen judi slot gacor untuk membuat pemain merasakan kenyamanan dan pengalaman yang tidak bisa di dapatkan di situs lain. Dan sebagai platform berkualitas, kami juga memberikan berbagai provider tidak kalah gacor seperti provider Pragmatic Play dan Pg Soft. Maka dari itu, semakin banyak peminat slot depo 10k melalui QRIS tercepat sengaja di resmikan oleh situs SLOT GACOR sebab menjadi agen judi terbesar dan terpercaya di Indonesia mengutamakan kenyamanan para member setia kami, sehingga kami sangat berharap kepada para pemain mendukung kami untuk selalu berkembang menjadi situs slot gacor terbesar di Indonesia partner resmi Slot88 dan ke depannya semakin dipercaya oleh para pemain slot di seluruh Indonesia.</p>
            ...
            <div class="row justify-content-center g-lg-0">
              <div class="col-lg-6 col-md-4 col-12">
                <div class="footer-top-item">
                  <div class="d-flex justify-content-end">&copy; 2024 Slot Gacor | Bisa aja. All rights reserved </div>
                </div>
              </div>
            </div>
          </div>
      ...
      <amp-sidebar id="sidebar-menu" layout="nodisplay" side="right">
        <ul>
          <li>
            <a href="https://t.ly/kage303">Beranda</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Hot Games</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Slots</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Live Casino</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Sports</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Arcade</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Poker</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Togel</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Promosi</a>
          </li>
          <li>
            <a href="https://t.ly/kage303">Live TV</a>
          </li>
        </ul>
      </amp-sidebar>
      <div class="floating">
        <a class="cta-daftar text-center d-block btn-blink" href="https://t.ly/kage303">Daftar Slot Gacor</a>
      </div>
  </body>
</html>
